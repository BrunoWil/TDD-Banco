...
% ---------- TÍTULO ----------
\begin{center}
  {\fontsize{16}{20}\selectfont\bfseries Confiabilidade em Sistemas Financeiros: Prevenção de Erros Críticos em Software Bancário com Test-Driven Development}\\[2em]
\end{center}
...
Este estudo focou em um componente simplificado de sistema bancário. O Trabalho não explorar:
...
\bibitem{knight2012}
SECURITIES AND EXCHANGE COMMISSION. \textbf{In the Matter of Knight Capital Americas LLC}. Administrative Proceeding File No. 3-15570. Washington, DC, 2013. Disponível em: \url{https://www.sec.gov/litigation/admin/2013/34-70694.pdf}. Acesso em: 10 nov. 2025.

\bibitem{maruf2021}
MARUF, Ramishah. \textbf{Citi transferiu acidentalmente US\$ 500 milhões a mais e não pode pegar de volta}. CNN Brasil, 17 fev. 2021. Disponível em: \url{https://www.cnnbrasil.com.br/economia/macroeconomia/citibank-transfere-us-500-milhoes-para-conta-errada-e-nao-pode-pegar-de-volta/}. Acesso em: 10 nov. 2025.
